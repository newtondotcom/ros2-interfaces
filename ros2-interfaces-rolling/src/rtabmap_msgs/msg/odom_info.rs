...
pub struct OdomInfo {
    ...
    pub local_bundle_avg_inlier_distance: f32,
    pub local_bundle_max_key_frames_for_inlier: i32,
...
impl Default for OdomInfo {
    fn default() -> Self {
        OdomInfo {
            ...
            local_bundle_avg_inlier_distance: 0.0,
            local_bundle_max_key_frames_for_inlier: 0,
