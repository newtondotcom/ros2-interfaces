...
pub struct RCGCD15 {
    ...
    pub teams: [crate::gc_spl_interfaces::msg::TeamInfo15; 2],
}
...
impl RCGCD15 {
    ...
    pub const COMPETITION_TYPE_DYNAMIC_BALL_HANDLING: u8 = 1;
...
impl Default for RCGCD15 {
    fn default() -> Self {
        RCGCD15 {
            ...
            secs_remaining: 0,
            secondary_time: 0,
            teams: core::array::from_fn(|_| crate::gc_spl_interfaces::msg::TeamInfo15::default()),
        }
    }
}

impl ros2_client::Message for RCGCD15 {}
