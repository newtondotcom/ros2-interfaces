...
pub struct TeamInfo {
    ...
    pub players: [crate::rcgcd_spl_14::msg::RobotInfo; 7],
}
...
impl Default for TeamInfo {
    fn default() -> Self {
        TeamInfo {
            ...
            single_shots: 0,
            message_budget: 0,
            players: core::array::from_fn(|_| crate::rcgcd_spl_14::msg::RobotInfo::default()),
        }
    }
}

impl ros2_client::Message for TeamInfo {}
