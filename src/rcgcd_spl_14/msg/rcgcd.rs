...
pub struct RCGCD {
    ...
    pub teams: [crate::rcgcd_spl_14::msg::TeamInfo; 2],
}
...
impl Default for RCGCD {
    fn default() -> Self {
        RCGCD {
            ...
            secs_remaining: 0,
            secondary_time: 0,
            teams: core::array::from_fn(|_| crate::rcgcd_spl_14::msg::TeamInfo::default()),
        }
    }
}

impl ros2_client::Message for RCGCD {}
