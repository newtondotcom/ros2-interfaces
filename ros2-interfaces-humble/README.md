...
on the [ROS Index for humble](https://index.ros.org/packages/#humble).
...
```toml
[dependencies]
ros2-interfaces-humble = { version = "*", features = ["std_msgs"] }  # replace with the latest version and features you need
```
